...
/**
 * This interface exposes functions from credential manager on Windows platform
 * via JNA. It internally makes use of Windows Advanced Services API (Advapi32.dll) to
 * interact with Windows Credential Manager.
 * Please refer to MSDN documentations for each method usage pattern
 */
interface CredentialAdvancedServiceApi32 extends StdCallLibrary {
  CredentialAdvancedServiceApi32 INSTANCE = (CredentialAdvancedServiceApi32) Native.load("Advapi32",
                                                                                         CredentialAdvancedServiceApi32.class, W32APIOptions.UNICODE_OPTIONS);
  /**
   * CredRead flag
   */
